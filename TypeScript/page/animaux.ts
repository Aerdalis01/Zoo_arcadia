...
const cerfForm = document.getElementById('cerfForm') as HTMLElement;
const cerfBtn = document.getElementById('cerfBtn') as HTMLElement;
...
const toggleButtons = document.querySelectorAll('.view-animal') as NodeListOf<HTMLButtonElement>;
console.log(toggleButtons);
const animalForm = document.querySelectorAll('.animaux-form') as NodeListOf<HTMLElement>;
